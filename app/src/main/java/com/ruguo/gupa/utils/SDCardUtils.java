...
import com.ruguo.gupa.common.MValue;
...
public class SDCardUtils {
    ...
    public static String getRootPathFilePath() {
        File file = new File(MAPP.mapp.getExternalFilesDir(MValue.SD_PATH_ROOT), MValue.SD_PATH_FILE);
        if (!file.mkdirs()) {
            file.mkdir();
        }
        return file.getPath();
